    ...
    <div className="px-6 pt-12 pb-8">
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-4 gap-3">
          <SocialIcon
            label="WhatsApp"
            href="https://wa.me/78722123456"
            color="#25D366"
            icon={<WhatsAppIcon />}
          />
          <SocialIcon
            label="Telegram"
            href="https://t.me/drosmanov"
            color="#2AABEE"
            icon={<TelegramIcon />}
          />
          <SocialIcon
            label="VK"
            href="https://vk.com/drosmanov"
            color="#0077FF"
            icon={<VKIcon />}
          />
          <SocialIcon
            label="YouTube"
            href="https://youtube.com/@drosmanov"
            color="#FF0000"
            icon={<YouTubeIcon />}
          />
          <SocialIcon
            label="Instagram*"
            href="https://instagram.com/drosmanov"
            color="#E4405F"
            icon={<InstagramIcon />}
          />
          <SocialIcon
            label="Facebook*"
            href="https://facebook.com/drosmanov"
            color="#1877F2"
            icon={<FacebookIcon />}
          />
        </div>

        {/* Правовая плашка Meta */}
        <div className="mt-5 bg-brand-subtle/50 border border-line rounded-md p-4 flex items-start gap-3">
          ...
          <p className="text-[11px] text-ink-secondary leading-relaxed">
            * Instagram и&nbsp;Facebook принадлежат компании Meta, которая признана
...
/* ═══ Официальные иконки соцсетей (SVG) ═══ */
